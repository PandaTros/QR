    ...
    <div class="container">
        <div class="row">
            <div class="col-12 my-5">
                <p class="text-center text-white txw-600 tx-26">PROYECTOS</p>
                <p class="text-center text-white txw-400 tx-14">Inicio > Proyectos</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <img src="<?php echo $mostrar['Imagen'] ?>" class="img-projects w-100" height="200px" alt="cargando..."  data-bs-toggle="collapse" data-bs-target="#id<?php echo $mostrar['id'] ?>" aria-expanded="false">
                      <div class="collapse" id="id<?php echo $mostrar['id'] ?>">
                        <div class="card card-body text-center">
                            ...
                            <a class="login100-form-btn my-1 tx-16" href="{{ route('cotizas.create') }}">Cotizar un proyecto como este</a>
                        </div>
                      </div>
                </div>
                <?php
